package com.example.delivery.Activities.profiles.Delivery.home.orders.details
...
import com.example.delivery.Activities.profiles.Delivery.map.DeliveryOrdersMapActivity
    ...
    private fun updateOrder() {
        ...
        call?.enqueue(object: Callback<NewResponseHttp> {
            override fun onResponse(call: Call<NewResponseHttp>, response: Response<NewResponseHttp>) {
                ...
                if (response.body() != null) {
                    ...
                    if (response.body()?.success == true) {
                        ...
                        Toast.makeText(this@DeliveryOrdersDetailActivity, "No se pudo iniciar el reparto", Toast.LENGTH_SHORT).show()
                    }
                }
                else {
            ...
            override fun onFailure(p0: Call<NewResponseHttp>, p1: Throwable) {
                ...
                Toast.makeText(this@DeliveryOrdersDetailActivity, "Error: ${p1.message}", Toast.LENGTH_SHORT).show()
            }
        })
    }
