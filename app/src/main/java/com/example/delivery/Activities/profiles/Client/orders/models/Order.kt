package com.example.delivery.Activities.profiles.Client.orders.models
...
class Order(
    ...
    @SerializedName("id_address") val idAddress: String? = null,
    ...
    @SerializedName("address") val address: AddressModel? = null
) {
