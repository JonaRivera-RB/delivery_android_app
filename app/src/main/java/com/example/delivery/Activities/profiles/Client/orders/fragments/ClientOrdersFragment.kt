...
import com.example.delivery.Activities.profiles.Client.orders.adapter.ClientTabsPagerAdapter
...
class ClientOrdersFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val adapter = ClientTabsPagerAdapter(childFragmentManager, lifecycle, numberOfTabs)
